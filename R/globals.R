utils::globalVariables(c('.', 'esp_nom_latin', 'localisation', 'ope_id', 'passerelle_taxo',
  'type_peche', 'unique_dataset_id', 'unique_obs_id', 'unique_obs_id_new', 'unique_obs_id_old',
